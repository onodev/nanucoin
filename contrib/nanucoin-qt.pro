...
RESOURCES += src/qt/nanucoin.qrc src/qt/nanucoin_locale.qrc

TRANSLATIONS += src/qt/locale/nanucoin_bg.ts \
                src/qt/locale/nanucoin_de.ts \
                src/qt/locale/nanucoin_en.ts \
                src/qt/locale/nanucoin_es.ts \
                src/qt/locale/nanucoin_fi.ts \
                src/qt/locale/nanucoin_fr.ts \
                src/qt/locale/nanucoin_it.ts \
                src/qt/locale/nanucoin_ja.ts \
                src/qt/locale/nanucoin_pl.ts \
                src/qt/locale/nanucoin_pt.ts \
                src/qt/locale/nanucoin_ru.ts \
                src/qt/locale/nanucoin_sk.ts \
                src/qt/locale/nanucoin_sv.ts \
                src/qt/locale/nanucoin_vi.ts \
                src/qt/locale/nanucoin_zh_CN.ts \
                src/qt/locale/nanucoin_zh_TW.ts
