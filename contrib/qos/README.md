...
This means one can have an always-on nanucoind instance running, and another local nanucoind/nanucoin-qt instance which connects to this node and receives blocks from it.
