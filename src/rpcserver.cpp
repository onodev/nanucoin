...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NanuCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "NanuCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NanuCoin features */
        {"nanucoin", "masternode", &masternode, true, true, false},
        {"nanucoin", "masternodelist", &masternodelist, true, true, false},
        {"nanucoin", "mnbudget", &mnbudget, true, true, false},
        {"nanucoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"nanucoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nanucoin", "mnsync", &mnsync, true, true, false},
        {"nanucoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"nanucoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nanucoind, or the -server option to nanucoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nanucoin-cli " + methodname + " " + args + "\n";
}
