...
/** Utility functions used by the NanuCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render NanuCoin addresses in monospace font
...
// Parse "nanucoin:" URI into recipient object, return true on successful parsing
