NanuCoin Core version 2.2.1 is now available from:

  <https://github.com/nanucoin-project/nanucoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/nanucoin-project/nanucoin/issues>

Compatibility
==============

NanuCoin Core is extensively tested on multiple operating systems using
...
NanuCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that NanuCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/nanucoin-project-translations/).
