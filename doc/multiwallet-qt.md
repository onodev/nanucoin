...
In order to support loading of multiple wallets in nanucoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nanucoin.cpp.
...
Changes to nanucoin.cpp
----------------------
nanucoin.cpp is the entry point into nanucoin-qt, and as such, will require some minor modifications to provide hooks for
