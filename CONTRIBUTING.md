Contributing to NanuCoin Core
============================

The NanuCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NanuCoin Core project, and is not to be
confused with overall NanuCoin Network Protocol consensus changes.

Whether a pull request is merged into NanuCoin Core rests with the project merge
...
Patches that change NanuCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the NanuCoin consensus, it must have been
...
The project leader is the release manager for each NanuCoin Core release.
